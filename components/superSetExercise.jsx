...
const SuperSetExercise = ({ exercise }) => {
  const {
    excersice_1_name,
    ...
    excersice_1_weight,
    excersice_2_name,
    excersice_2_max_reps,
    excersice_2_min_reps,
    excersice_2_sets,
    excersice_2_weight,
  } = exercise;
  return (
    <div className="w-11/12 mx-auto bg-gray-100 rounded-lg my-2 p-2">
      <h1 className=" font-bold text-lg">Superset</h1>
      ...
      <div className="flex justify-between px-4 p-2 ">
        <div className="flex flex-col">
          <h1 className="font-bold">{excersice_2_name}</h1>
          <h1 className="text-gray-500 text-sm">{`${excersice_2_sets} sets of ${excersice_2_min_reps}-${excersice_2_max_reps}`}</h1>
        </div>
        <h1 className="text-indigo-600 font-bold">{`${excersice_2_weight} Kg`}</h1>
      </div>
    </div>
  );
};
